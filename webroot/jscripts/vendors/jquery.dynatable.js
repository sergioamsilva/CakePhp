...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      paginationPrev: '<i class="icon-caret-left icon-large"></i>',
      paginationNext: '<i class="icon-caret-right icon-large"></i>',
  ...
  function RecordsCount(obj, settings) {
    ...
    this.create = function() {
      ...
      if (recordsShown < recordsQueryCount && settings.features.paginate) {
        ...
        text += "<span class='dynatable-record-bounds'>" + (bounds[0] + 1) + " até " + bounds[1] + "</span> do Total de ";
      } else if (recordsShown === recordsQueryCount && settings.features.paginate) {
        text += recordsShown + " de ";
      }
      text += recordsQueryCount + " " + collection_name;
      if (recordsQueryCount < recordsTotal) {
        text += " (filtradas de " + recordsTotal + " entradas)";
      }
